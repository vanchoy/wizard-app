...
import thumb_6 from '../../img/thumb-6-2.jpg';
...
const ProductN3 = () => {
    return (
        <>
                        <HelmetComponent
                title='ADBL VAMPIRE (Fælgerens) - Wizard Mobil Bilpleje'
        ...
        <ProductStyle className="grid-s1 section-bg">
            <section className="grid-row-1 grid-col-3-7">
                <header>
                    <h2 className="section-heading-title">ADBL VAMPIRE <br />(Fælgerens)</h2>
                    <h4 className="section-heading-sub-title">Lær mere om produktet</h4>
                </header>
                <SectionP className="section-paragraph">
                Fælgrens med en neutral pH til at fjerne dybt indlejrede metalliske forureninger fra fælge og lak. Den raffinerede gel formel muliggør længere arbejde med produktet end med konkurrerende produkter. En applikation påført med en pensel muliggør gentagen virkning af produktet. På denne måde kan man forlænge virkningen med endnu flere minutter efter hver fordeling med en børste, og opløse meget kraftig snavs og bremsestøv fra bremseklodserne med en lille mængde af produktet. Ideel til at fjerne bremsestøv fra bilens bremseklodser og flyverust af fælge og lak. Sikker til brug på lakerede hjul og poleret aluminium.
                </SectionP>
            ...
            <div className="grid-row-1 grid-col-7-11 section-image center-2">
                <SectionImage className="clean" src={thumb_6} alt="Bil alufælge rens kosmetik" />
            </div>
        </ProductStyle>
        </>
    );
