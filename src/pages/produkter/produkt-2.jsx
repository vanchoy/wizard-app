            ...
            <ProductStyle className="grid-s1 section-bg">
                <section className="grid-row-1 grid-col-3-7">
                    ...
                    <SectionP className="section-paragraph">
                        Fuldsyntetisk quick detailer. Produktet indeholder en høj dosis af polymerer og syntetisk voks. Er ideel til fjernelse af støv, fingeraftryk og lette kalkaflejringer fra hårdt vand. Produktet har intens duft, fordamper hurtigt og efterlader ingen striber. Ideel til brug efter hver vask. Forlænger levetiden af voks, og giver glans, dybde og beskyttelse til den næste bilvask.
                </SectionP>
