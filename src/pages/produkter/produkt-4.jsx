...
import thumb_5 from '../../img/thumb-5-2.jpg';
...
const ProductN4 = () => {
    return (
        <>
            <HelmetComponent
                title='ADBL TIRE DRESSING (Dækfarver) - Wizard Mobil Bilpleje'
            ...
            <ProductStyle className="grid-s1 section-bg">
                <section className="grid-row-1 grid-col-3-7">
                    <header>
                        <h2 className="section-heading-title">ADBL TIRE DRESSING <br />(Dækfarver)</h2>
                        <h4 className="section-heading-sub-title">Lær mere om produktet</h4>
                    </header>
                    <SectionP className="section-paragraph">
                        ADBL TIRE DRESSING er en kombination af de bedste polymerer, harpiks og siliciumdioxid til at genskabe udseendet af fabrikkens dæk. Effekten af mørkfarvning, satin glans og beskyttelse mod UV-stråler, forureninger og vand kommer efter en simpel applikation. Derudover har produktet en meget intens og behagelig aroma.
                </SectionP>
                    <SectionP className="section-paragraph center-2">
                        Pric: 1 Liter - 129kr / 10 Liter - 999kr
                </SectionP>
                ...
                <div className="grid-row-1 grid-col-7-11 section-image center-2">
                    <SectionImage className="clean" src={thumb_5} alt="Bildæk dressing kosmetik" />
                </div>
            </ProductStyle>
        </>
    );
