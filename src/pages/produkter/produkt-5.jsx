...
import thumb_1 from '../../img/thumb-1-2.jpg';
...
const ProductN5 = () => {
    return (
        <>
            <HelmetComponent
                title='ADBL APC PRO (Interiør rengøring) - Wizard Mobil Bilpleje'
            ...
            <ProductStyle className="grid-s1 section-bg">
                <section className="grid-row-1 grid-col-3-7">
                    <header>
                        <h2 className="section-heading-title">ADBL APC PRO <br />(Interiør rengøring)</h2>
                        <h4 className="section-heading-sub-title">Lær mere om produktet</h4>
                    </header>
                    <SectionP className="section-paragraph">
                        Koncentreret, meget stærkt, alsidigt produkt til at rense de kraftigste forureninger fra plast, vinyl, polstrede materialer. Perfekt til rengøring af dele på ydersiden af bilen. Lav skumevne beriget med citrus olier. Affedtningsmiddel med meget gode egenskaber. Hurtig virkende mod skidt og snavs.
                </SectionP>
                    <SectionP className="section-paragraph center-2">
                        Pris: 1 Liter - 89kr / 10 Liter - 699kr
                </SectionP>
                ...
                <div className="grid-row-1 grid-col-7-11 section-image center-2">
                    <SectionImage className="clean" src={thumb_1} alt="Indvendig rengøring bil kosmetik" />
                </div>
            </ProductStyle>
        </>
    );
