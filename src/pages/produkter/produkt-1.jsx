...
import thumb_4 from '../../img/thumb-4-2.jpg';
...
const ProductN1 = () => {
    return (
        <>
            <HelmetComponent
                title='ADBL Shampoo (Lakrens) - Wizard Mobil Bilpleje'
            ...
            <ProductStyle className="grid-s1 section-bg">
                <section className="grid-row-1 grid-col-3-7">
                    <header>
                        <h2 className="section-heading-title">ADBL Shampoo <br />(Lakrens)</h2>
                        <h4 className="section-heading-sub-title">Lær mere om produktet</h4>
                    </header>
                    <SectionP className="section-paragraph">
                        Meget koncentreret premium autoshampoo. Shampooen har en neutral pH-værdi, som er skånsom for alle overflader på din bil. Tilføjelsen af æteriske olier fra citron og appelsin gør den i stand til at fjerne selv de mest genstridige forureninger. Produktet indeholder glansforstærkere og duften af cola gør rengøring mere behagelig.
                </SectionP>
                ...
                <div className="grid-row-1 grid-col-7-11 section-image center-2">
                    <SectionImage className="clean" src={thumb_4} alt="Bil shampoo kosmetik" />
                </div>
            </ProductStyle>
        </>
    );
