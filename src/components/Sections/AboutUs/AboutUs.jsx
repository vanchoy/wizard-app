...
import heroImage from '../../../img/about-us-image.JPG';
...
const AboutUsStyle = styled.section`
    /* ====== SECTION STYLE SETTINGS ====== */
        /* ~  (Section Syle)  ~ */
            ...
            --section-bg-s1-padding: 60px 20px 60px 20px;
...
const AboutUs = () => {
    return (
        <AboutUsStyle className="grid-s1 section-bg">

            <section className="grid-row-1 grid-col-3-7">
                <header>
                    <h2 className="section-heading-title">Om os</h2>
                    <h4 className="section-heading-sub-title">Lær mere om os</h4>
                </header>
                <SectionP className="section-paragraph">
                    Wizard Mobil Bilpleje er et af få virksomheder, som tilbyder mobil
                    bilpleje tjenester i hele Nordjylland. Vi specialiserer os i detailing -
                    industri, det vokser hurtig i Danmark. Vi kan komme og vaske din
                    bil eller rense bil interiør hos dig - vi har vores egen strømkilde og
                    vi bruger dampvask maskine, som bruger kun 3 liter vand pr. vask,
                    så alt er miljøvenlig. Derudover bruger vi kun bedste maskiner -
                    blandt andet Rupes, Karcher eller Valet Pro, som er meget bekendt
                    i detailing verden. Hos vores garage kan vi lave professionelt voks
                    behandling med 6 eller 12 måneder garanti, 1/2/3 trins bil polering,
                    polering og maling af alufælge, reparationer af mindre lakskader
                    eller rust og reparationer af træelementer og læder sæder. Vi bruger
                    ADBL bil kosmetik og det er muligt at bestille dem på vores
                    hjemmeside. Hvis du vil høre mere - ring eller skriv til os!
                </SectionP>
                <div className="center-2">
                    <Link to="/mmdi0918/1074175/wizard-app-fixed/kontakt" className="center-2">
                        <Button>
                            Kontakt os
            ...
            <div className="grid-row-1 grid-col-7-11 section-image center-2">
                <SectionImage className="clean" src={heroImage} alt="Skumforvask af køretøj" />
            </div>
        </AboutUsStyle>
    );
}
